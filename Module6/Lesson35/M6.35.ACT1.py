...
background_image = pygame.transform.scale(pygame.image.load("CBD1.jpeg"),(SCREEN_WIDTH, SCREEN_HEIGHT))

font = pygame.font.SysFont("Orbitron", FONT_SIZE)
...
while running:
    ...
    if won:
        win_text = font.render("YOU WIN!", True, pygame.Color((57, 255, 20)))
